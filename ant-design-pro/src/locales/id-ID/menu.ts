export default {
  ...
  'menu.form': 'Form',
  'menu.form.basic-form': 'SysUserForm Dasar',
  'menu.form.step-form': 'SysUserForm Bertahap',
  'menu.form.step-form.info': 'SysUserForm Bertahap(menulis informasi yang dibagikan)',
  'menu.form.step-form.confirm': 'SysUserForm Bertahap(konfirmasi informasi yang dibagikan)',
  'menu.form.step-form.result': 'SysUserForm Bertahap(selesai)',
  'menu.form.advanced-form': 'SysUserForm Lanjutan',
  'menu.list': 'Daftar',

export default {
  ...
  'menu.form': 'Form',
  'menu.form.basic-form': 'UserListForm Dasar',
  'menu.form.step-form': 'UserListForm Bertahap',
  'menu.form.step-form.info': 'UserListForm Bertahap(menulis informasi yang dibagikan)',
  'menu.form.step-form.confirm': 'UserListForm Bertahap(konfirmasi informasi yang dibagikan)',
  'menu.form.step-form.result': 'UserListForm Bertahap(selesai)',
  'menu.form.advanced-form': 'UserListForm Lanjutan',
  'menu.list': 'Daftar',
